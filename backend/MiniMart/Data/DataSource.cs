...
namespace MiniMart.Models
{
    public class DataSource
    {
        ...
        {
            new Customer { CustomerId = 1,  CustomerCode = "KH001", FullName = "Nguyễn Thị Hoa",    PhoneNumber = "0911000001", Email = "hoa.nguyen@gmail.com",  Address = "12 Lê Lợi, Q.1, TP.HCM",          Point = 150, TotalSpent = 1500000,  CustomerStatus = true },
            new Customer { CustomerId = 2,  CustomerCode = "KH002", FullName = "Trần Văn Bình",     PhoneNumber = "0911000002", Email = "binh.tran@gmail.com",   Address = "45 Nguyễn Huệ, Q.1, TP.HCM",      Point = 300, TotalSpent = 3000000,  CustomerStatus = true },
            new Customer { CustomerId = 3,  CustomerCode = "KH003", FullName = "Lê Thị Cẩm",       PhoneNumber = "0911000003", Email = "cam.le@gmail.com",      Address = "78 Trần Hưng Đạo, Q.5, TP.HCM",   Point = 80,  TotalSpent = 800000,   CustomerStatus = true },
            new Customer { CustomerId = 4,  CustomerCode = "KH004", FullName = "Phạm Minh Đức",     PhoneNumber = "0911000004", Email = "duc.pham@gmail.com",    Address = "23 Võ Thị Sáu, Q.3, TP.HCM",      Point = 500, TotalSpent = 5000000,  CustomerStatus = true },
            new Customer { CustomerId = 5,  CustomerCode = "KH005", FullName = "Hoàng Thị Ế",       PhoneNumber = "0911000005", Email = "e.hoang@gmail.com",     Address = "56 Đinh Tiên Hoàng, Q.Bình Thạnh", Point = 200, TotalSpent = 2000000,  CustomerStatus = true },
            new Customer { CustomerId = 6,  CustomerCode = "KH006", FullName = "Vũ Quốc Phong",     PhoneNumber = "0911000006", Email = "phong.vu@gmail.com",    Address = "34 CMT8, Q.10, TP.HCM",            Point = 420, TotalSpent = 4200000,  CustomerStatus = true },
            new Customer { CustomerId = 7,  CustomerCode = "KH007", FullName = "Đặng Thị Giàu",     PhoneNumber = "0911000007", Email = "giau.dang@gmail.com",   Address = "90 Lý Thường Kiệt, Q.10, TP.HCM",  Point = 60,  TotalSpent = 600000,   CustomerStatus = true },
            new Customer { CustomerId = 8,  CustomerCode = "KH008", FullName = "Bùi Văn Hải",       PhoneNumber = "0911000008", Email = "hai.bui@gmail.com",     Address = "11 Phan Đăng Lưu, Q.Bình Thạnh",   Point = 750, TotalSpent = 7500000,  CustomerStatus = true },
            new Customer { CustomerId = 9,  CustomerCode = "KH009", FullName = "Ngô Thị Iris",      PhoneNumber = "0911000009", Email = "iris.ngo@gmail.com",    Address = "67 Xô Viết Nghệ Tĩnh, Q.Bình Thạnh",Point = 110, TotalSpent = 1100000,  CustomerStatus = true },
            new Customer { CustomerId = 10, CustomerCode = "KH010", FullName = "Trịnh Minh Khoa",   PhoneNumber = "0911000010", Email = "khoa.trinh@gmail.com",  Address = "28 Điện Biên Phủ, Q.Bình Thạnh",   Point = 330, TotalSpent = 3300000,  CustomerStatus = true },
            new Customer { CustomerId = 11, CustomerCode = "KH011", FullName = "Lý Thị Lan",        PhoneNumber = "0911000011", Email = "lan.ly@gmail.com",      Address = "5 Nơ Trang Long, Q.Bình Thạnh",    Point = 90,  TotalSpent = 900000,   CustomerStatus = true },
            new Customer { CustomerId = 12, CustomerCode = "KH012", FullName = "Phan Văn Mạnh",     PhoneNumber = "0911000012", Email = "manh.phan@gmail.com",   Address = "42 Hai Bà Trưng, Q.1, TP.HCM",    Point = 650, TotalSpent = 6500000,  CustomerStatus = true },
            new Customer { CustomerId = 13, CustomerCode = "KH013", FullName = "Đinh Thị Nga",      PhoneNumber = "0911000013", Email = "nga.dinh@gmail.com",    Address = "17 Trường Chinh, Q.Tân Bình",       Point = 40,  TotalSpent = 400000,   CustomerStatus = true },
            new Customer { CustomerId = 14, CustomerCode = "KH014", FullName = "Cao Thanh Oanh",    PhoneNumber = "0911000014", Email = "oanh.cao@gmail.com",    Address = "88 Hoàng Văn Thụ, Q.Tân Bình",     Point = 270, TotalSpent = 2700000,  CustomerStatus = true },
            new Customer { CustomerId = 15, CustomerCode = "KH015", FullName = "Mai Văn Phát",      PhoneNumber = "0911000015", Email = "phat.mai@gmail.com",    Address = "3 Bạch Đằng, Q.Tân Bình",          Point = 180, TotalSpent = 1800000,  CustomerStatus = true },
            new Customer { CustomerId = 16, CustomerCode = "KH016", FullName = "Trương Thị Quỳnh",  PhoneNumber = "0911000016", Email = "quynh.truong@gmail.com",Address = "54 Nguyễn Thái Sơn, Q.Gò Vấp",    Point = 520, TotalSpent = 5200000,  CustomerStatus = true },
            new Customer { CustomerId = 17, CustomerCode = "KH017", FullName = "Đỗ Minh Quân",      PhoneNumber = "0911000017", Email = "quan.do@gmail.com",     Address = "29 Quang Trung, Q.Gò Vấp",         Point = 95,  TotalSpent = 950000,   CustomerStatus = true },
            new Customer { CustomerId = 18, CustomerCode = "KH018", FullName = "Hồ Thị Sương",      PhoneNumber = "0911000018", Email = "suong.ho@gmail.com",    Address = "71 Lê Đức Thọ, Q.Gò Vấp",          Point = 380, TotalSpent = 3800000,  CustomerStatus = false },
            new Customer { CustomerId = 19, CustomerCode = "KH019", FullName = "Lương Văn Tài",     PhoneNumber = "0911000019", Email = "tai.luong@gmail.com",   Address = "6 Nguyễn Oanh, Q.Gò Vấp",          Point = 210, TotalSpent = 2100000,  CustomerStatus = true },
            new Customer { CustomerId = 20, CustomerCode = "KH020", FullName = "Dương Thị Uyên",    PhoneNumber = "0911000020", Email = "uyen.duong@gmail.com",  Address = "38 Phan Văn Trị, Q.Gò Vấp",        Point = 460, TotalSpent = 4600000,  CustomerStatus = true },
            new Customer { CustomerId = 21, CustomerCode = "KH021", FullName = "Kiều Thanh Vân",    PhoneNumber = "0911000021", Email = "van.kieu@gmail.com",    Address = "13 Phạm Văn Đồng, Q.Bình Thạnh",   Point = 130, TotalSpent = 1300000,  CustomerStatus = true },
            new Customer { CustomerId = 22, CustomerCode = "KH022", FullName = "Tô Văn Xuân",       PhoneNumber = "0911000022", Email = "xuan.to@gmail.com",     Address = "49 Nơ Trang Long, Q.Bình Thạnh",   Point = 700, TotalSpent = 7000000,  CustomerStatus = true },
        };
        ...
        {
            new Store { StoreId = 1, StoreCode = "STORE001", StoreName = "MiniMart Default Store", Address = "Default single-store deployment", PhoneNumber = "0900000000", Status = true },
        };
        ...
        {
            new Receipt { ReceiptId = 1, ReceiptCode = "PN001", ImportDate = new DateTime(2024, 1, 10), TotalAmount = 5000000, PaidAmount = 5000000, DebtAmount = 0, ReceiptStatus = true, SupplierId = 1, EmployeeId = 4, StoreId = 1 },
            new Receipt { ReceiptId = 2, ReceiptCode = "PN002", ImportDate = new DateTime(2024, 1, 15), TotalAmount = 7500000, PaidAmount = 7500000, DebtAmount = 0, ReceiptStatus = true, SupplierId = 2, EmployeeId = 4, StoreId = 1 },
            new Receipt { ReceiptId = 3, ReceiptCode = "PN003", ImportDate = new DateTime(2024, 2, 5),  TotalAmount = 4200000, PaidAmount = 2000000, DebtAmount = 2200000, ReceiptStatus = true, SupplierId = 3, EmployeeId = 7, StoreId = 1 },
            new Receipt { ReceiptId = 4, ReceiptCode = "PN004", ImportDate = new DateTime(2024, 3, 1),  TotalAmount = 6800000, PaidAmount = 6800000, DebtAmount = 0, ReceiptStatus = true, SupplierId = 4, EmployeeId = 9, StoreId = 1 },
            new Receipt { ReceiptId = 5, ReceiptCode = "PN005", ImportDate = new DateTime(2024, 4, 10), TotalAmount = 3500000, PaidAmount = 3500000, DebtAmount = 0, ReceiptStatus = true, SupplierId = 5, EmployeeId = 4, StoreId = 1 },
        };
        ...
        {
            new Batch { BatchId = 1,  BatchCode = "BATCH001", ManufactureDate = new DateTime(2023, 11, 1), ExpiryDate = new DateTime(2025, 11, 1), ImportPrice = 23000,  QuantityImported = 200, QuantityRemaining = 150, Status = true, ProductId = 18, ReceiptId = 1 },
            new Batch { BatchId = 2,  BatchCode = "BATCH002", ManufactureDate = new DateTime(2023, 12, 1), ExpiryDate = new DateTime(2025, 12, 1), ImportPrice = 23000,  QuantityImported = 160, QuantityRemaining = 120, Status = true, ProductId = 19, ReceiptId = 1 },
            new Batch { BatchId = 3,  BatchCode = "BATCH003", ManufactureDate = new DateTime(2024, 1, 1),  ExpiryDate = new DateTime(2025, 7, 1),  ImportPrice = 20000,  QuantityImported = 200, QuantityRemaining = 160, Status = true, ProductId = 20, ReceiptId = 1 },
            new Batch { BatchId = 4,  BatchCode = "BATCH004", ManufactureDate = new DateTime(2024, 1, 5),  ExpiryDate = new DateTime(2026, 1, 5),  ImportPrice = 4000,   QuantityImported = 500, QuantityRemaining = 400, Status = true, ProductId = 24, ReceiptId = 2 },
            new Batch { BatchId = 5,  BatchCode = "BATCH005", ManufactureDate = new DateTime(2024, 1, 5),  ExpiryDate = new DateTime(2026, 1, 5),  ImportPrice = 3000,   QuantityImported = 400, QuantityRemaining = 350, Status = true, ProductId = 25, ReceiptId = 2 },
            new Batch { BatchId = 6,  BatchCode = "BATCH006", ManufactureDate = new DateTime(2023, 10, 1), ExpiryDate = new DateTime(2025, 10, 1), ImportPrice = 5000,   QuantityImported = 300, QuantityRemaining = 250, Status = true, ProductId = 1,  ReceiptId = 2 },
            new Batch { BatchId = 7,  BatchCode = "BATCH007", ManufactureDate = new DateTime(2023, 10, 1), ExpiryDate = new DateTime(2025, 10, 1), ImportPrice = 8000,   QuantityImported = 300, QuantityRemaining = 280, Status = true, ProductId = 3,  ReceiptId = 2 },
            new Batch { BatchId = 8,  BatchCode = "BATCH008", ManufactureDate = new DateTime(2023, 9, 1),  ExpiryDate = new DateTime(2025, 9, 1),  ImportPrice = 18000,  QuantityImported = 150, QuantityRemaining = 100, Status = true, ProductId = 11, ReceiptId = 3 },
            new Batch { BatchId = 9,  BatchCode = "BATCH009", ManufactureDate = new DateTime(2023, 8, 1),  ExpiryDate = new DateTime(2025, 8, 1),  ImportPrice = 35000,  QuantityImported = 100, QuantityRemaining = 80,  Status = true, ProductId = 12, ReceiptId = 3 },
            new Batch { BatchId = 10, BatchCode = "BATCH010", ManufactureDate = new DateTime(2024, 2, 1),  ExpiryDate = new DateTime(2026, 2, 1),  ImportPrice = 42000,  QuantityImported = 100, QuantityRemaining = 90,  Status = true, ProductId = 36, ReceiptId = 4 },
            new Batch { BatchId = 11, BatchCode = "BATCH011", ManufactureDate = new DateTime(2024, 2, 1),  ExpiryDate = new DateTime(2026, 2, 1),  ImportPrice = 58000,  QuantityImported = 80,  QuantityRemaining = 70,  Status = true, ProductId = 37, ReceiptId = 4 },
            new Batch { BatchId = 12, BatchCode = "BATCH012", ManufactureDate = new DateTime(2024, 2, 1),  ExpiryDate = new DateTime(2026, 2, 1),  ImportPrice = 40000,  QuantityImported = 90,  QuantityRemaining = 80,  Status = true, ProductId = 38, ReceiptId = 4 },
            new Batch { BatchId = 13, BatchCode = "BATCH013", ManufactureDate = new DateTime(2024, 3, 1),  ExpiryDate = new DateTime(2026, 3, 1),  ImportPrice = 42000,  QuantityImported = 100, QuantityRemaining = 90,  Status = true, ProductId = 41, ReceiptId = 5 },
            new Batch { BatchId = 14, BatchCode = "BATCH014", ManufactureDate = new DateTime(2024, 3, 1),  ExpiryDate = new DateTime(2026, 3, 1),  ImportPrice = 58000,  QuantityImported = 90,  QuantityRemaining = 80,  Status = true, ProductId = 42, ReceiptId = 5 },
            new Batch { BatchId = 15, BatchCode = "BATCH015", ManufactureDate = new DateTime(2024, 3, 1),  ExpiryDate = new DateTime(2026, 3, 1),  ImportPrice = 55000,  QuantityImported = 110, QuantityRemaining = 100, Status = true, ProductId = 43, ReceiptId = 5 },
        };
        ...
        {
            new Shift { ShiftId = 1, ShiftName = "Ca sáng",   StartTime = new DateTime(2024, 6, 1, 6, 0, 0),  EndTime = new DateTime(2024, 6, 1, 14, 0, 0),  WorkDate = new DateTime(2024, 6, 1), StartCash = 500000, EndCash = 3200000, Revenue = 2700000, Status = ShiftStatus.Closed, EmployeeId = 1, StoreId = 1, CashierId = 2,  ClosedAt = new DateTime(2024, 6, 1, 14, 5, 0) },
            new Shift { ShiftId = 2, ShiftName = "Ca chiều",  StartTime = new DateTime(2024, 6, 1, 14, 0, 0), EndTime = new DateTime(2024, 6, 1, 22, 0, 0), WorkDate = new DateTime(2024, 6, 1), StartCash = 500000, EndCash = 4100000, Revenue = 3600000, Status = ShiftStatus.Closed, EmployeeId = 1, StoreId = 1, CashierId = 3,  ClosedAt = new DateTime(2024, 6, 1, 22, 10, 0) },
            new Shift { ShiftId = 3, ShiftName = "Ca sáng",   StartTime = new DateTime(2024, 6, 2, 6, 0, 0),  EndTime = new DateTime(2024, 6, 2, 14, 0, 0),  WorkDate = new DateTime(2024, 6, 2), StartCash = 500000, EndCash = 2800000, Revenue = 2300000, Status = ShiftStatus.Closed, EmployeeId = 1, StoreId = 1, CashierId = 5,  ClosedAt = new DateTime(2024, 6, 2, 14, 2, 0) },
            new Shift { ShiftId = 4, ShiftName = "Ca chiều",  StartTime = new DateTime(2024, 6, 2, 14, 0, 0), EndTime = new DateTime(2024, 6, 2, 22, 0, 0), WorkDate = new DateTime(2024, 6, 2), StartCash = 500000, EndCash = 5200000, Revenue = 4700000, Status = ShiftStatus.Closed, EmployeeId = 1, StoreId = 1, CashierId = 6,  ClosedAt = new DateTime(2024, 6, 2, 22, 8, 0) },
            new Shift { ShiftId = 5, ShiftName = "Ca sáng",   StartTime = new DateTime(2024, 6, 3, 6, 0, 0),  EndTime = new DateTime(2024, 6, 3, 14, 0, 0),  WorkDate = new DateTime(2024, 6, 3), StartCash = 500000, EndCash = 0,       Revenue = 0,       Status = ShiftStatus.Working, EmployeeId = 1, StoreId = 1, CashierId = 10, ClosedAt = null },
        };

        // ========================= ORDERS =========================
        public static List<Order> GetOrders() => new List<Order>
        {
            new Order { OrderId = 1,  OrderCode = "HD001", SubTotal = 66000,  PromotionDiscount = 0,     TaxAmount = 0, TotalAmount = 66000,  DiscountAmount = 0,    FinalAmount = 66000,  PaidAmount = 70000,  ChangeAmount = 4000,  PaymentMethod = PaymentMethod.Cash,         Status = OrderStatus.Completed, EmployeeId = 2,  StoreId = 1, CustomerId = 1 },
            new Order { OrderId = 2,  OrderCode = "HD002", SubTotal = 110000, PromotionDiscount = 0,     TaxAmount = 0, TotalAmount = 110000, DiscountAmount = 0,    FinalAmount = 110000, PaidAmount = 110000, ChangeAmount = 0,     PaymentMethod = PaymentMethod.BankTransfer,  Status = OrderStatus.Completed, EmployeeId = 2,  StoreId = 1, CustomerId = 4 },
            new Order { OrderId = 3,  OrderCode = "HD003", SubTotal = 55000,  PromotionDiscount = 5000,  TaxAmount = 0, TotalAmount = 55000,  DiscountAmount = 5000, FinalAmount = 50000,  PaidAmount = 50000,  ChangeAmount = 0,     PaymentMethod = PaymentMethod.Cash,         Status = OrderStatus.Completed, EmployeeId = 3,  StoreId = 1, CustomerId = 2 },
            new Order { OrderId = 4,  OrderCode = "HD004", SubTotal = 180000, PromotionDiscount = 0,     TaxAmount = 0, TotalAmount = 180000, DiscountAmount = 0,    FinalAmount = 180000, PaidAmount = 200000, ChangeAmount = 20000, PaymentMethod = PaymentMethod.Cash,         Status = OrderStatus.Completed, EmployeeId = 3,  StoreId = 1, CustomerId = 8 },
            new Order { OrderId = 5,  OrderCode = "HD005", SubTotal = 92000,  PromotionDiscount = 0,     TaxAmount = 0, TotalAmount = 92000,  DiscountAmount = 0,    FinalAmount = 92000,  PaidAmount = 100000, ChangeAmount = 8000,  PaymentMethod = PaymentMethod.Cash,         Status = OrderStatus.Completed, EmployeeId = 5,  StoreId = 1, CustomerId = 3 },
            new Order { OrderId = 6,  OrderCode = "HD006", SubTotal = 245000, PromotionDiscount = 10000, TaxAmount = 0, TotalAmount = 245000, DiscountAmount = 10000,FinalAmount = 235000, PaidAmount = 235000, ChangeAmount = 0,     PaymentMethod = PaymentMethod.BankTransfer,  Status = OrderStatus.Completed, EmployeeId = 6,  StoreId = 1, CustomerId = 12 },
            new Order { OrderId = 7,  OrderCode = "HD007", SubTotal = 38000,  PromotionDiscount = 0,     TaxAmount = 0, TotalAmount = 38000,  DiscountAmount = 0,    FinalAmount = 38000,  PaidAmount = 40000,  ChangeAmount = 2000,  PaymentMethod = PaymentMethod.Cash,         Status = OrderStatus.Completed, EmployeeId = 5,  StoreId = 1, CustomerId = null },
            new Order { OrderId = 8,  OrderCode = "HD008", SubTotal = 130000, PromotionDiscount = 0,     TaxAmount = 0, TotalAmount = 130000, DiscountAmount = 0,    FinalAmount = 130000, PaidAmount = 130000, ChangeAmount = 0,     PaymentMethod = PaymentMethod.CreditCard,    Status = OrderStatus.Completed, EmployeeId = 10, StoreId = 1, CustomerId = 6 },
            new Order { OrderId = 9,  OrderCode = "HD009", SubTotal = 75000,  PromotionDiscount = 0,     TaxAmount = 0, TotalAmount = 75000,  DiscountAmount = 0,    FinalAmount = 75000,  PaidAmount = 80000,  ChangeAmount = 5000,  PaymentMethod = PaymentMethod.Cash,         Status = OrderStatus.Completed, EmployeeId = 2,  StoreId = 1, CustomerId = 10 },
            new Order { OrderId = 10, OrderCode = "HD010", SubTotal = 320000, PromotionDiscount = 20000, TaxAmount = 0, TotalAmount = 320000, DiscountAmount = 20000,FinalAmount = 300000, PaidAmount = 300000, ChangeAmount = 0,     PaymentMethod = PaymentMethod.BankTransfer,  Status = OrderStatus.Completed, EmployeeId = 12, StoreId = 1, CustomerId = 22 },
        };
